...
#define TEST_RANDOM_MAC					/* test stabilization */
#define TEST_EXRTC_CHECK_DATEERR		/* ExRTC Check Date Time Error Test */
#endif
 ...
 * @param ram_dateTime RAMに書き込む日時データ
 * @retval None
 */
//void writeRAM_OneHourProgressTime(DATE_TIME *ram_dateTime);
 ...
 * @retval None
 */
//void acc_value_offset_set(void);
